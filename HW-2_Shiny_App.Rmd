...
renderPlot({
  ...
  ggplot(movietype, aes(x=budget, y=rating)) +
  geom_point(color = "violetred4") +
  geom_smooth(se = FALSE, color = "cadetblue1") +
  theme_minimal()+
  labs(title="Does the budget of a movie effect its IMDB Rating", x="Budget", y="Rating in IMDB")
